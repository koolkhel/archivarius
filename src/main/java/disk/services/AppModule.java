...
import disk.controller.ControllerImpl;
import disk.data.DiskDAO;
import disk.data.DiskDAOImpl;
import disk.data.FileDAO;
import disk.data.FileDAOImpl;
...
public class AppModule {
	public static void bind(ServiceBinder binder) {
		...
		binder.bind(Controller.class, ControllerImpl.class);
		binder.bind(DiskDAO.class, DiskDAOImpl.class);
	}
	...
	public static void contributeApplicationDefaults(
		...
		// configuration.add(SymbolConstants.CHARSET, "cp1251");
	}
	...
	public static void contributeHibernateEntityPackageManager(
		...
		configuration.add("disk.entities");
	}
